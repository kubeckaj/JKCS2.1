...
def main():
    ...
    if args.test:
        ...
        C_index = molecules[0].constrained_indexes['C']
        H_index = molecules[0].constrained_indexes['H']
        O_index = molecules[0].constrained_indexes['O']
        ...
        if molecules:
            for molecule in molecules:
                # print(molecule.name, good_active_site(molecule))
