...
data_label="\Sigma{\it\gamma} [s^{-1}]";
ylabel(cb,data_label,'LineWidth',Lwidth,'FontSize',1.5*Fsize,'FontWeight','demi')
ylabel(["\fontsize{20}" Yname])
xlabel(["\fontsize{20}" Xname])
title("\fontsize{20}Total evaporation rate")
