...
%   Detailed explanation goes here
  ...
  %comman=dcommand+" --dip ../ACDC_input/dip_pol_298.15K.txt";
  %command=command+" --no_generic_ions";
  command=command+" --use_cs --cs exp_loss --exp_loss_coefficient 0.001 --exp_loss_exponent -1.6 ";
  %command=command+" --use_cs --exp_loss_ref_cluster 1sa --cs exp_loss --exp_loss_coefficient 0.001 --exp_loss_exponent -1.6 ";
