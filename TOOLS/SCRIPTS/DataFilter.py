...
def printhelp():
  ...
  print('  -u1   2      uniqueness grid on 2 decimals for Rg (column 1+1) [default=2]')
  print('  -u2   5      uniqueness grid on 5 decimals for E  (column 2+1) [default=3]')
  print('  -u3   4      uniqueness grid on 4 decimals for     column 3+1  [default=3]')
  ...
  print('   JKCS5_filter collectionXTB.txt -u -u1 2 -u2 1 -sort 2 //you can use collection if you use -u')
