...
if Qqha == 1:
  ...
  clusters_df = thermodynamics(clusters_df, Qanh, Qfc, Qt)
  if Qout == 2:
...
if len(Pout) > 0:
  ...
  output = array(print_output(clusters_df,Qoutpkl,input_pkl,output_pkl,Qsplit,Qclustername,Qt,Qcolumn,Pout,QUenergy,QUentropy))
  if Qout == 2:
